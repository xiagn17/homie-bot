...
export type HandlerOnUserTypeRoute = (ctx: MyContext, next: NextFunction) => Promise<void>;
...
export type ChooseUserType = (type: TelegramUserType, ctx: MyContext, next: NextFunction) => Promise<void>;
