...
export class LandlordsTextsService {
  ...
  getObjectFormPlaceOnSitesText(): string {
    return (
      ...
      `Чтобы поиск съемщика проходил быстрее, а количество анкет было больше, мы можем <b>бесплатно</b> разместить ваше объявление на ЦИАН и других площадках\n` +
      `\n` +
      `${EMOJI_ATTENTION}️ Ваши контакты не увидят пользователи, которых вы не одобрили.`
    );
  }
